...
config.set(
    ...
    True,
    "file:///C:/Users/henry/AppData/Roaming/qutebrowser/data/userscripts/*",
)
...
# config.set('qt.args', ['--no-sandbox', '--frameless'])
config.set("qt.args", ["--no-sandbox", "--window-decoration=none"])
# config.set('scrolling.step', 20)  # Smaller value = finer scrolling
# config.set('scrolling.bar', 'never')  # Hide the scrollbar completely
